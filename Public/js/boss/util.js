...
BOSS.domain = '119.29.108.86:8080';
 ...
 */
BOSS.api = {
    //要通知子站时，请求token和要通知的子站
    getNoticeInfo: 'http://' + BOSS.domain + '/sso/getnoticeinfo',
    //*===================栏目管理=====================*//
    //获取所有栏目
    ...
    //*===================管理员管理=====================*//
    //用户列表
    getUserList : 'http://' + BOSS.domain + '/user/getReadJson/',
    //获取列表辅助信息
    getOtherInfo : 'http://' + BOSS.domain + '/user/getOtherInfo/',
    //锁定、解锁用户
    lockedUser : 'http://' + BOSS.domain + '/user/lockedUser/',
    //重置用户密码
    reSetUserPW : 'http://' + BOSS.domain + '/user/reSetUserPW/',
